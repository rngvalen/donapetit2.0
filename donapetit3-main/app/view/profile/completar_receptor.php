...
<head>
  ...
  <title>Completar Perfil - Receptor</title>
  ...
  <div class="mx-auto max-w-3xl">
    <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl">
      ...
      <div class="text-center mb-8">
        <h1 class="text-2xl font-extrabold text-slate-900">Completa tu perfil de Receptor</h1>
        <p class="mt-2 text-sm text-slate-600">Ingresa los datos de tu institución y ubicación</p>
      </div>
      ...
      <form method="post" action="?controller=Profile&action=guardarReceptor" class="space-y-6" id="formReceptor">
        ...
        <div class="border-t pt-6">
          <h2 class="text-lg font-semibold text-slate-900 mb-4">Dirección de la institución</h2>
