    ...
    <?php if (!empty($solicitudes)): ?>
        <div class="mt-6 space-y-4">
            <?php foreach ($solicitudes as $solicitud): ?>
                ...
                $institucion = htmlspecialchars((string)($solicitud['institucion_receptor'] ?? 'Institución desconocida'), ENT_QUOTES, 'UTF-8');
                ...
                <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 grid gap-3 sm:grid-cols-2">
                        ...
                        <div class="rounded-lg bg-slate-50 px-4 py-3">
                            <p class="text-xs font-medium uppercase tracking-wide text-slate-500">Institución</p>
                    ...
                    <div class="mt-5 flex gap-3">
                        <form action="index.php?controller=Solicitud&action=confirmar" method="POST" class="flex-1" onsubmit="return confirm('¿Confirmar esta solicitud? Se restará el stock automáticamente.');">
