...
class SolicitudController extends Controller
{
    ...
    public function missolicitudes(): void
    {
        ...
        // Marcar solicitudes como vistas (eliminar notificaciones)
        $this->solicitudModel->marcarComoVistoPorReceptor($idReceptor);
    ...
    /**
     * Aprueba una solicitud y RESERVA el stock (no lo descuenta aún)
     */
    public function aprobar(): void
    {
        ...
        if ($this->solicitudModel->aprobarYReservarStock($idSolicitud)) {
            $_SESSION['success'] = 'Solicitud aprobada. Stock reservado por 2 horas. El receptor debe retirar los productos.';
        } else {
            $_SESSION['error'] = 'Error al aprobar la solicitud. Verifica que haya stock suficiente.';
        }
    ...
    public function confirmarRetiro(): void
    {
        ...
        if ($this->solicitudModel->confirmarRetiro($idSolicitud)) {
            $_SESSION['success'] = 'Retiro confirmado. El stock se descontó definitivamente.';
        } else {
