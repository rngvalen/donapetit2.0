...
<head>
  ...
  <title>Mapa de <?= $rolTexto ?> - DonAppetit</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center">
          ...
          <a href="?controller=Home&action=index" class="flex items-center space-x-3">


            <div class="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-md">


              <span class="text-brand font-bold text-lg">DA</span>


            </div>


            <span class="text-white font-bold text-xl">DonAppetit</span>
        ...
        <?php if (isset($_SESSION['user'])): ?>
          ...
          <div class="flex items-center space-x-4">
            ...
            <span class="text-white text-sm">
              ...
              Hola, <strong><?= htmlspecialchars($_SESSION['user']['name'] ?? 'Usuario') ?></strong>
            ...
            <a href="?controller=Auth&action=logout" 
               ...
               class="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-white text-sm font-medium transition">
  ...
  <section id="donapp-map" class="mx-auto w-full max-w-6xl py-8 px-4 flex flex-col gap-8">
    ...
    <header>
      ...
      <p class="mt-2 max-w-2xl text-sm text-slate-500">
        ...
        Encontr% <?= $rolTexto ?> con productos disponibles cerca de tu ubicaci%%n.
      ...
      <p class="mt-1 text-xs text-slate-400">
         ...
         Tu ubicaci%%n: <strong><?= htmlspecialchars($userDir) ?></strong>
    ...
    <div class="grid gap-8 lg:grid-cols-[2fr,1fr]">
      ...
      <div class="space-y-6">
        ...
        <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
          ...
          <h2 class="text-lg font-semibold text-slate-900">Filtros r%pidos</h2>
      ...
      <aside class="flex flex-col gap-6">
        ...
        <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl">
          ...
          <h2 class="text-lg font-semibold text-slate-900">Radio de b%Q%squeda</h2>


          <p class="mt-2 text-sm text-slate-500">Ajust% el alcance en kil%%metros</p>
  ...
  (function () {
    ...
    function initMap() {
      ...
      L.marker([userLocation.lat, userLocation.lng], { icon: userIcon })
        ...
        .bindPopup('<strong>Tu ubicaci%%n</strong><br><?= htmlspecialchars($userDir) ?>');
