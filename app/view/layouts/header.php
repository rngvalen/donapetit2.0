            ...
            <div class="flex items-center gap-3 ml-auto">
                ...
                if ($userRole === 'donante' && $notificaciones > 0) {
                    ...
                    try {
                        require_once __DIR__ . '/../../model/Solicitud.php';
                        $solicitudModel = new Solicitud();
                        // Solo mostrar solicitudes Aprobadas como notificaciones (nuevas respuestas del donante)
                        $totalNotificaciones = $solicitudModel->contarPorEstado($userId, 'Aprobada');
