  ...
  <div class="mx-auto max-w-3xl">
    <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/5">
      <header class="mb-6 text-center">
        ...
        <h1 class="mt-2 text-2xl font-extrabold text-slate-900">Complet tu perfil de donante</h1>
        <p class="mt-2 text-sm text-slate-500">
          Necesitamos algunos datos de tu comercio y su ubicacin para mostrar tus donaciones en el mapa.
        </p>
      </header>

      <?php if ($needsProfile): ?>
        <div class="mb-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
          An no registramos la informacin de tu comercio. Complet el formulario para habilitar todas las funcionalidades.
        </div>
      <?php endif; ?>
      ...
      <form method="post" action="?controller=Profile&action=guardarDonante" class="space-y-8">
        <section>
        ...
        <section class="border-t border-slate-100 pt-6">
          <h2 class="text-lg font-semibold text-slate-900">Direccin del comercio</h2>
          <div class="mt-4 grid gap-4 md:grid-cols-2">
            <div>
          ...
          <p class="mt-6 text-sm text-slate-500">Indic la ubicacin exacta en el mapa (arrastrando el marcador o haciendo clic sobre la ubicacin).</p>
