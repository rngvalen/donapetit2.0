...
<section class="flex items-center justify-center py-10">
  <div class="w-full max-w-sm rounded-3xl bg-white p-8 text-center shadow-xl shadow-slate-900/5">
    ...
    <h1 class="text-2xl font-semibold text-brand">Recuperar contrasena</h1>
    <p class="mt-1 text-sm text-slate-500">Te enviaremos un codigo por email</p>
    ...
    <form method="post"
          action="?controller=Auth&action=enviarCodigo"
